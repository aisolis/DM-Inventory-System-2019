...
Public Class Recibos_a_proveedor
    ...
    Private Sub Txtchequeno_KeyDown(sender As Object, e As KeyEventArgs) Handles txtchequeno.KeyDown
        If e.KeyCode = Keys.Enter Then
            txtvalor.Select()
        End If
    End Sub
    ...
    Private Sub Txtvalorrecibido_KeyDown(sender As Object, e As KeyEventArgs) Handles txtvalorrecibido.KeyDown
        If e.KeyCode = Keys.Enter Then
            txtefectivo.Select()
        End If
    End Sub
    ...
    Private Sub Txtidbanco_KeyDown(sender As Object, e As KeyEventArgs) Handles txtidbanco.KeyDown
        If e.KeyCode = Keys.Enter Then
            Try
                con.Close()
                con.Open()
                Dim Consulta As String = "Select * from bancos where id_banco = '" & txtidbanco.Text & "'"
                Dim lista As Byte
                Dim datos As New DataSet
                Dim adaptador = New SqlDataAdapter(Consulta, con)
                datos = New DataSet
                adaptador.Fill(datos, "banco")
                lista = datos.Tables("banco").Rows.Count
                If lista <> 0 Then
                    cmbbanco.Text = datos.Tables("banco").Rows(0).Item("banco")
                    con.Close()
                    txtchequeno.Select()
                Else
                    con.Close()
    ...
    Private Sub Txtidproveedor_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtidproveedor.KeyPress, txtvalorrecibido.KeyPress, txtvalor.KeyPress, txtserie.KeyPress, txtidbanco.KeyPress, txtefectivo.KeyPress, txtdocumento.KeyPress, txtchequeno.KeyPress, txtcantidad.KeyPress, txt_producto.KeyPress
    ...
    Private Sub Btneliminar_Click(sender As Object, e As EventArgs) Handles btneliminar.Click
        If txtdocumento.Text <> "" AndAlso txtserie.Text <> "" Then
            sentencia = "delete from recibosproveedores where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "'"
    ...
    Private Sub BtnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        ...
        End If
        If txtdocumento.Text <> "" AndAlso txtserie.Text <> "" Then
            sentencia = "update recibosproveedores set Id_Proveedor='" + txtidproveedor.Text + "',Serie='" + txtserie.Text + "',no_documento  ='" + txtdocumento.Text + "',Anulado='" + anulado + "',fecha='" + txtfecha.Text + "',valorrecibido='" + txtvalorrecibido.Text.Replace(",", ".") + "',formadepago='" + cmbforma.Text + "',efectivo='" + txtefectivo.Text.Replace(",", ".") + "',id_banco='" + txtidbanco.Text + "',chequeno='" + txtchequeno.Text + "',valor='" + txtvalor.Text.Replace(",", ".") + "',totalgeneral='" + txttotal.Text.Replace(",", ".") + "' where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "'"
    ...
    Private Sub Btnagregar_Click(sender As Object, e As EventArgs) Handles btnagregar.Click
        ...
        End If
        If txtdocumento.Text <> "" AndAlso txtserie.Text <> "" Then
            sentencia = "insert into recibosproveedores values('" + txtidproveedor.Text + "','" + txtserie.Text + "','" + txtdocumento.Text + "','" + anulado + "','" + txtfecha.Text + "','" + txtvalorrecibido.Text.Replace(",", ".") + "','" + cmbforma.Text + "','" + txtefectivo.Text.Replace(",", ".") + "','" + txtidbanco.Text + "','" + txtchequeno.Text + "','" + txtvalor.Text.Replace(",", ".") + "','" + txttotal.Text.Replace(",", ".") + "')"
    ...
    Private Sub Btneliminarfila_Click(sender As Object, e As EventArgs) Handles btneliminarfila.Click
        Try
            con.Close()
            Dim Consulta As String = "select * from detrecibosproveedores where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "'"
            Dim datos As New DataSet
            Dim lista As Byte
            Dim adaptador = New SqlDataAdapter(Consulta, con)
            datos = New DataSet
            adaptador.Fill(datos, "detrecibosproveedores")
            lista = datos.Tables("detrecibosproveedores").Rows.Count
            If lista <> 0 Then
                eliminar = datos.Tables("detrecibosproveedores").Rows(0).Item("cantidad")
                sentencia6 = "delete from detrecibosproveedores where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "' and id_producto='" + txt_producto.Text + "'"
    ...
    Private Sub Btnmodificarfila_Click(sender As Object, e As EventArgs) Handles btnmodificarfila.Click
        Try
            con.Close()
            con.Open()
            Dim Consulta As String = "select Sum(cantidad) AS SUMA from detrecibosproveedores where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "' and id_producto='" + txt_producto.Text + "'"
            Dim lista As Byte
            Dim datos As New DataSet
            Dim adaptador = New SqlDataAdapter(Consulta, con)
            datos = New DataSet
            ...
            lista = datos.Tables("detrecibosproveedores").Rows.Count
            If lista <> 0 Then
                detalle = datos.Tables("detrecibosproveedores").Rows(0).Item("SUMA")
            End If
            If txt_producto.Text <> "" Then
                con.Close()
                con.Open()
                sentencia = "update detrecibosproveedores set serie='" + txtserie.Text + "',no_documento='" + txtdocumento.Text + "',Id_Proveedor='" + txtidproveedor.Text + "',Id_Producto='" + txt_producto.Text + "', cantidad='" + txtcantidad.Text + "', precio='" + txtprecio.Text.Replace(",", ".") + "', totaldet='" + txtsubtotal.Text.Replace(",", ".") + "' where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "' and id_producto='" + txt_producto.Text + "'"
                con.Close()
    ...
    Private Sub Btninsertarfila_Click(sender As Object, e As EventArgs) Handles btninsertarfila.Click
        Try
            con.Close()
            Dim Consulta As String = "select * from detrecibosproveedores where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "' and id_producto='" + txt_producto.Text + "'"
            Dim lista As Byte
            Dim datos As New DataSet
            Dim adaptador = New SqlDataAdapter(Consulta, con)
            datos = New DataSet
            ...
            If lista <> 0 Then
                con.Close()
                con.Open()
                Dim Consulta2 As String = "select Sum(cantidad) AS SUMA from detrecibosproveedores where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "'"
                Dim lista2 As Byte
                Dim datos2 As New DataSet
                Dim adaptador2 = New SqlDataAdapter(Consulta2, con)
                datos2 = New DataSet
                adaptador2.Fill(datos2, "detrecibosproveedores")
                lista2 = datos2.Tables("detrecibosproveedores").Rows.Count
                If lista2 <> 0 Then
                    detalle = datos2.Tables("detrecibosproveedores").Rows(0).Item("SUMA")
                    sentencia5 = "update detrecibosproveedores set Serie='" + txtserie.Text + "',no_documento='" + txtdocumento.Text + "',Id_Proveedor='" + txtidproveedor.Text + "',Id_Producto='" + txt_producto.Text + "', cantidad='" + txtcantidad.Text + "', precio='" + txtprecio.Text.Replace(",", ".") + "', totaldet='" + txtsubtotal.Text.Replace(",", ".") + "' where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "' and id_producto='" + txt_producto.Text + "'"
                    con.Close()
            ...
            Else
                ...
                If txt_producto.Text <> "" Then
                    con.Close()
                    con.Open()
                    sentencia = "insert into detrecibosproveedores values('" + txtserie.Text + "','" + txtdocumento.Text + "','" + txtidproveedor.Text + "','" + txt_producto.Text + "','" + txtcantidad.Text + "','" + txtprecio.Text.Replace(",", ".") + "','" + txtsubtotal.Text.Replace(",", ".") + "')"
                    con.Close()
    ...
    Private Sub Recibos_a_proveedor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtfecha.Text = DateTime.Now.ToString("dd/MM/yyyy")
    End Sub
    ...
    Sub mostrar()
        Try
            ...
            If lista <> 0 Then
                ...
                cmd.CommandText = "select * from detrecibosproveedores where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "'"
                cmd.ExecuteNonQuery()
                ...
                recuperar_total()
                dt.DefaultView.RowFilter = "no_documento like '" + txtdocumento.Text + "%' and serie like '" + txtserie.Text + "%'"
                con.Close()
            Else
    ...
    End Sub
    Sub mostrar2()
        Dim Dap As New SqlDataAdapter("select * from detrecibosproveedores", con)
    ...
    Public Sub recuperar_total()
        con.Close()
        Dim Consulta1 As String = "select Sum(totaledet) AS SUMA from detrecibosproveedores where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "'"
        Dim lista1 As Byte
        Dim datos1 As New DataSet
        Dim adaptador1 = New SqlDataAdapter(Consulta1, con)
        datos1 = New DataSet
        adaptador1.Fill(datos1, "detrecibosproveedores")
        lista1 = datos1.Tables("detrecibosproveedores").Rows.Count
        If lista1 <> 0 Then
            txttotal.Text = datos1.Tables("detrecibosproveedores").Rows(0).Item("SUMA")
        End If
    End Sub
    Sub recuperartotal()
        Try
            con.Close()
            con.Open()
            Dim Consulta As String = "select Sum(totaledet) AS SUMA from detrecibosproveedores where no_documento='" + txtdocumento.Text + "' and serie='" + txtserie.Text + "'"
            Dim lista As Byte
            Dim datos As New DataSet
            Dim adaptador = New SqlDataAdapter(Consulta, con)
            datos = New DataSet
            ...
            lista = datos.Tables("detrecibosproveedores").Rows.Count
            If lista <> 0 Then
                txttotal.Text = datos.Tables("detrecibosproveedores").Rows(0).Item("SUMA")
                con.Close()
            Else
                con.Close()
            End If
